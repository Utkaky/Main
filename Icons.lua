...
Instance.new("UICorner", Lucide).CornerRadius = UDim.new(0, 15)
local UIStroke = Instance.new("UIStroke", Lucide)
...
Open.Image = "rbxassetid://121377864496432"
Open.Size = UDim2.new(0, 52, 0, 52)
Open.Position = UDim2.new(0, 12, 0, 25)
Open.Visible = false
Open.Active = true
Open.Draggable = true
...
RemoveBtn.Image = "rbxassetid://110786993356448"
RemoveBtn.Size = UDim2.new(0, 26, 0, 26)
RemoveBtn.Position = UDim2.new(0, 556, 0, 4)
...
Close.Image = "rbxassetid://118026365011536"
Close.Size = UDim2.new(0, 26, 0, 26)
Close.Name = "Close"
Close.Position = UDim2.new(0, 519, 0, 4)
Close.Parent = TopBar
...
SearchBox.PlaceholderText = "Search 1645 icons ..."
...
CopyID.BackgroundTransparency = 1
CopyID.Image = "rbxassetid://124735040937171"
CopyID.Size = UDim2.new(0,46,0,46)
CopyID.Position = UDim2.new(0,542,0,58)
CopyID.Parent = Lucide
Instance.new("UICorner", CopyID)

local CopyName = Instance.new("ImageButton")
CopyName.BorderSizePixel = 0
CopyName.BackgroundTransparency = 1
CopyName.Image = "rbxassetid://109059477680782"
CopyName.Size = UDim2.new(0,46,0,46)
CopyName.Position = UDim2.new(0,542,0,112)
CopyName.Parent = Lucide
Instance.new("UICorner", CopyName)
...
NameLabel.Size = UDim2.new(0,168,0,30)
NameLabel.Position = UDim2.new(0,424,0,225)
NameLabel.Text = ""
NameLabel.TextColor3 = Color3.fromRGB(91,91,91)
NameLabel.Parent = Lucide
...
local UIGrid = Instance.new("UIGridLayout", IconScroll)
...
local function refreshCanvas()
	IconScroll.CanvasSize = UDim2.new(0,0,0,UIGrid.AbsoluteContentSize.Y + 20)
end
...
for i,data in ipairs(SortedIcons) do
	...
	ImgBtn.Position = UDim2.new(0.5,-25,0,8)
	...
	ImgBtn.MouseButton1Click:Connect(function()
		PreviewImage.Image = data.Asset
		IDLabel.Text = data.Asset:match("%d+$") or ""
...
CopyID.MouseButton1Click:Connect(function()
	if IDLabel.Text ~= "" then
		pcall(function() setclipboard(IDLabel.Text) end)
	end
end)

CopyName.MouseButton1Click:Connect(function()
	if NameLabel.Text ~= "" then
		pcall(function() setclipboard(NameLabel.Text) end)
	end
end)
...
-- Close/Open tween (tối ưu, không lag)
